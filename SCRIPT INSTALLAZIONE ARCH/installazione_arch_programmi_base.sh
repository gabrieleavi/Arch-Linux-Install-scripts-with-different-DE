...
pacman -S grub efibootmgr os-prober $browser bluez bluez-utils alsa-utils pulseaudio pulseaudio-bluetooth mtools dialog xdg-utils xdg-user-dirs networkmanager network-manager-applet cups git reflector sddm plasma-meta kde-application
